...
//     return total;
// }
// console.log(arrSum(points));
// console.log(arrSum([23, 45]));
// console.log(arrSum([1, 2, 3, 4, 5]));

// const spratOddEven = function(numArr) {
//    let oddArr = [];
//     let oddArrIndex = 0;
...
// const fiveElementsArr = [];
// let fiveElementsArrIndex = 0;

// for (i in points) {
//   if (i >= 5) break;
//   fiveElementsArr[fiveElementsArrIndex++] = points[i];
// };
